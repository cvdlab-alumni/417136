...
STRUTTURA1 = STRUCT([piano,opera1,A,fiume,PONTE,AREA,STRUTTIRAPALAZZI,STRUTTIRAPALAZZI1,STRUTTIRAPALAZZI2,STRUTTIRAPALAZZI4,wallSOLIDSTRADE1,wallSOLIDSTRADAFINALY1,wallSOLIDSTRADAFINALY22,wallSOLIDSTRADAFINALY23,wallSOLIDSTRADAFINALY24,wallSOLIDSTRADAFINALY25,wallSOLIDSTRADAFINALY1W,wallSOLIDSTRADAFINALY2W,wallSOLIDSTRADAFINALY3W,wallSOLIDSTRADAFINALY4W])


###LAMPIONE


BASE = CYLINDER([0.05,1.5])(30)
LAMP = SPHERE(0.2)([36,36])
LAMP1 = T(3)(1.5)(LAMP)
LAMPIONE = STRUCT([BASE,LAMP1])
LAMPIONE1 = COLOR(YELLOW)(T([1,2])([149,-14])(LAMPIONE))
STRUCTLAMP = STRUCT([LAMPIONE1, T(1)(-4)]*75)

##ALBERI

TRONCO = CYLINDER([0.1,3])(30)
FOGLIE = CONE([0.4,4])(10)
ALB1 = T(3)(1.5)(FOGLIE)
ALBERO = STRUCT([COLOR(BROWN)(TRONCO),COLOR(GREEN)(ALB1)])
ALBERO1 = T([1,2])([-10,5])(ALBERO)
ALBERO2 = T([1,2])([-12,5])(ALBERO)
ALBERO3 = T([1,2])([-14,5])(ALBERO)
ALBERO11 = T([1,2])([-11,8])(ALBERO)
ALBERO21 = T([1,2])([-13,8])(ALBERO)
ALBERO31 = T([1,2])([-15,8])(ALBERO)
verprato = [[-8,2],[-17,2],[-8,10],[-17,10]]
cellsprato = [[1,2,3,4]]
polsprato = None
prato = MKPOL([verprato, cellsprato, polsprato])
SOLIDPRATO = COLOR(GREEN)(PROD([prato,Q(0.2)]))

ALBERI = STRUCT([ALBERO1,ALBERO2,ALBERO3,ALBERO11,ALBERO21,ALBERO31,SOLIDPRATO])
ALBERI2 = T([1,2])([20,30])(ALBERI)
ALBERI3 = T([1,2])([-90,-90])(ALBERI)
STRUCTR = STRUCT([ALBERI,ALBERI2,ALBERI3])
STRUCTR1 = T(1)(118)(STRUCTR)



STRUTTURAFINALE = STRUCT([STRUTTURA1,STRUCTLAMP,ALBERI,ALBERI2,ALBERI3,STRUCTR1])
